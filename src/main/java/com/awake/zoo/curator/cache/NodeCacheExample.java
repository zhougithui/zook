...
public class NodeCacheExample {
    ...
    public static void main(String[] args) throws Exception {
        TestingServer server = TestServerFactory.instance();
        CuratorFramework client = null;
        //File dataDirectory, int port, int electionPort, int quorumPort,
        // boolean deleteDataDirectoryOnClose, int serverId, int tickTime,
        // int maxClientCnxns, Map<String, Object> customProperties, String hostname
